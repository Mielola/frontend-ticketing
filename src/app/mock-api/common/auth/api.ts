...
export class AuthMockApi {
    ...
    private _userSubject = new BehaviorSubject<any>([])
    ...
    registerHandlers(): void {
        ...
        this._fuseMockApiService
            ...
            this._fuseMockApiService.onGet('api/get-user').reply(() => {
                const ids = localStorage.getItem('id')
                const findUser = users.find(user => ids === user.id)
                return [200, findUser]
            })
        // -----------------------------------------------------------------------------------------------------
